...
\*\* Jon's Comment: "I did not know you can use cowplot also. Might try that in the future."

```{r}
#| label: Setting up Data Frame

# Read zombies.csv and store data in dataframe df
df <- read.csv("C:/Users/Richard/Desktop/AN588 R Studio/Homework 3/zombies.csv")
...
pgrid1
```
** "I like the formatting you have here for question 2. Different from mine, but it works the same."
## Question 3
...
pgrid2
```
** Jon: "*thumbs up emoji. Looks pretty good."
### 3.2
...
```
**Jon's comment: "Looks good here too."
### 4.2
...
samp_stats
```
**Jon's comment: "Love the idea for presentation format. May try that myself."
### 5.2
...
lines(x_vals, y_vals, col = "red", lwd = 2)
```
**Jon's comment: "interestingly. seems like there are some values here that may be extended beyond what you have in your range. i don't know if you knew about this, but from what I can find online. they explained about "making a little more flexible approach to it by pre-specifying the desired set of values. Let me know if it works for you." 
...
**Jon's comment: "overall, looks pretty good. I'm not finding anything that may need to change. Everything seems well put and presentation."
